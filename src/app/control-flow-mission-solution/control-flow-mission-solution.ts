...
@Component({
  selector: 'app-control-flow-mission-solution',
  templateUrl: './control-flow-mission-solution.html',
  styleUrl: '../control-flow-mission/control-flow-mission.css',
})
export class ControlFlowMissionSolution {
